...
ActiveRecord::Schema.define(version: 20181212191951) do
  ...
  add_index "posts", ["river_id"], name: "index_posts_on_river_id"
  ...
  add_index "rivers", ["uuid"], name: "index_rivers_on_uuid"
